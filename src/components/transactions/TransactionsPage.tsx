    ...
    <div className="min-h-screen bg-background">
      <div className="flex h-screen relative">
        ...
        <div className="flex flex-col flex-1 h-screen">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-4 relative">
            <div className="flex flex-col lg:flex-row lg:items-center gap-4">
            ...
            {/* Filter Sidebar */}
            {showFilterSidebar && (
              <div className="absolute top-12 left-0 w-80 bg-white border border-border rounded-xl shadow-lg z-50 flex flex-col max-h-[500px]">
                {/* Filter Header */}
                ...
                {/* Filter Actions */}
                <div className="p-4 border-t border-border space-y-3 rounded-b-xl">
                  <Button
                  ...
                  <Button
                    variant="ghost"
                    className="w-full text-green-600 hover:text-green-700 hover:bg-green-50 rounded-lg"
                    onClick={() => {
        ...
        <div className="flex flex-1 overflow-hidden relative">
          {/* Left Content - Table */}
          <div className="flex-1 p-4 lg:p-6 overflow-hidden transition-all duration-300 mr-60">
